                            ...
                            {flashSale ? (
                                ...
                                selectedVariant.vat_percent && selectedVariant.vat_percent > 0 ? (
                                    <div className="flex flex-col gap-3 w-full max-w-lg mb-2">
                                        {/* Giá chưa VAT */}
                                        <div className="border border-blue-100 bg-[#f4f8fd] rounded-lg p-4">
                                            <p className="text-[11px] font-bold text-[#4285f4] tracking-wider mb-2 uppercase">Giá chưa bao gồm VAT</p>
                                            ...
                                            {dp > 0 && (
                                                <span className="text-sm text-slate-400 line-through font-medium mt-1 font-mono">
                                                    {formatVND(selectedVariant.price)}
                                                </span>
                                            )}
                                        </div>
                                        ...
                                        {/* Giá đã VAT */}
                                        <div className="border border-blue-100 bg-[#f4f8fd] rounded-lg p-4">
                                            <p className="text-[11px] font-bold text-[#4285f4] tracking-wider mb-2 uppercase">Giá đã bao gồm VAT ({selectedVariant.vat_percent}%)</p>
                                            <div className="flex items-baseline gap-3">
                                                <span className="text-2xl font-black text-red-600">
                                            ...
                                            {dp > 0 && (
                                                <span className="text-sm text-slate-400 line-through font-medium mt-1 font-mono flex">
